 ...
 */
public class AthleteSessionsFragment extends Fragment {
    ...
    public AthleteSessionsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_athlete_sessions, container, false);
    ...
    public void refreshTodaySessions() {
        AndroidNetworking.get(GroupSportsApiService.WORKSESSIONS_BY_ATHLETE_BY_DATE(session.getuserLoggedTypeId(),Funciones.formatDateForAPI(currentDate)))
