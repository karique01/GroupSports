 ...
 */
public class CoachQuizAllFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_coach_quiz_all, container, false);
    ...
    public void refreshQuizzesSessions() {
        AndroidNetworking.get(GroupSportsApiService.QUIZZES_BY_COACH(session.getuserLoggedTypeId()))
