...
public class AddMesocycleDialog extends AlertDialog implements DatePickerDialog.OnDateSetListener{
    ...
    public AddMesocycleDialog(Context context) {
        super(context);
        this.context = context;
        init();
    }

    public AddMesocycleDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        init();
    }

    public AddMesocycleDialog(Context context, int themeResId) {
    ...
    private void init() {
        ...
        View view = inflater.inflate(R.layout.dialog_add_mesocycle, null);
